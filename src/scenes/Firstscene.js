...
import Bacterium from "/src/classes/bacterium.js";
import Player from "/src/classes/player.js";
import Virus from "/src/classes/virus.js";
...
class Firstscene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load
      .image("background", "backgrounds/background.png")
  ...
  create() {
    ...
    this.lifesText = this.add.text(50, 10, "X " + this.lifesCounter, {
      fontStyle: "strong",
      align: "right",
      font: "24px Arial",
      fill: "beige"
    ...
    this.ammoText = this.add.text(
      ...
      10,
      "AMMO: " + this.ammo,
      { fontStyle: "strong", align: "right", font: "24px Arial", fill: "beige" }
    );
    ...
    this.soapImage = this.physics.add
      .image(40, this.sys.game.canvas.height - 30, "soap")
      .setActive(true)
      .setDepth(1)
      .setVisible(false);
    ...
    this.physics.add.overlap(
      this.player,
      [this.virusGroup, this.bacteriumGroup, this.powerupGroup],
      this.hitPlayer,
      null,
      this
    );
    this.physics.add.collider(
      this.bulletsGroup,
      [this.virusGroup, this.bacteriumGroup],
      this.hitEnemies,
      null,
      this
    );
